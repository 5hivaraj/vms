      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden">
        <div className="p-6 border-b border-gray-200 dark:border-gray-800">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            <div>
              <h2 className="text-xl font-semibold">Visitor Records</h2>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Click any row to view full visitor details
              </p>
            </div>
            <div className="flex flex-wrap gap-3">
              <input
                ...
                className="px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 focus:ring-2 focus:ring-blue-500 focus:outline-none min-w-[220px]"
              />
              <input
                type="date"
                value={dateFilter}
