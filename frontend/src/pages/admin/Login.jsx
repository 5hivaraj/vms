...
export default function AdminLogin() {
  ...
  return (
    <div className="min-h-full flex items-center justify-center px-4 py-8 bg-gradient-to-br from-slate-100 to-blue-100 dark:from-gray-950 dark:to-gray-900">
      <div className="w-full max-w-md bg-white dark:bg-gray-900 rounded-2xl shadow-xl p-6 sm:p-8 border border-gray-200 dark:border-gray-800">
        ...
        {!import.meta.env.DEV && <div className="mb-8" />}
